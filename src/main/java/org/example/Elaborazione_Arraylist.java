...
public class Elaborazione_Arraylist {
    ...
    void crea_lista(){
        add_Prodotti(1,50,"Iphone 13","Telefono",926.32);
        add_Prodotti(2,100,"Iphone 12","Telefono",776.99);
        add_Prodotti(3,150,"Iphone 12 Max","Telefono",800);
        add_Prodotti(4,200,"Iphone 11","Telefono",560.48);
        add_Prodotti(5,250,"Iphone XR","Telefono",500.12);
    }
    String all(){
        String msg="All: ";
